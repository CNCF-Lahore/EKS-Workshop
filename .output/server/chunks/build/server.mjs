import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, toRef, isRef, defineAsyncComponent, defineComponent, h, useAttrs, computed, toValue, useSSRContext, unref, provide, shallowReactive, Suspense, nextTick, Transition, createElementBlock, onUnmounted, shallowRef, onServerPrefetch, mergeProps, resolveComponent, withAsyncContext, createVNode, resolveDynamicComponent, createSlots, withCtx, openBlock, createBlock, Fragment, createTextVNode, createCommentVNode, renderList, toDisplayString, renderSlot, createApp, effectScope, reactive, onErrorCaptured, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { f as useRuntimeConfig$1, $ as $fetch$1, i as createError$1, G as defuFn, H as klona, I as hasProtocol, p as parseURL, J as withLeadingSlash, y as withBase, K as withTrailingSlash, w as withoutTrailingSlash, D as defu, j as joinURL, l as hash, z as createDefu, L as parseQuery, M as isEqual, N as createHooks, O as parse, P as getRequestHeader, Q as withQuery, R as isScriptProtocol, n as destr, S as setCookie, T as getCookie, U as deleteCookie, V as sanitizeStatusCode, W as toRouteMatcher, X as createRouter$1, Y as withHttps } from '../runtime.mjs';
...
import { ssrRenderAttrs, ssrRenderSlot, ssrInterpolate, ssrRenderComponent, ssrRenderVNode, ssrRenderList, ssrRenderClass, ssrRenderStyle, ssrRenderSuspense, ssrRenderTeleport } from 'vue/server-renderer';
...
const unhead_A0m63kUM0l = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./_...slug_-CBeCXe6l.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-DBr78e78.mjs').then((m) => m.default || m)
  }
];
...
const _0_siteConfig_Kam82Cto4d = /* @__PURE__ */ defineNuxtPlugin({
...
const revive_payload_server_K90jEFodTy = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-C0AgHQOJ.mjs').then((r) => r.default));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-CEemncOA.mjs').then((r) => r.default));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-DniIVNsJ.mjs').then((r) => r.default));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-y9c4dz5E.mjs').then((r) => r.default));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-Hqid709l.mjs').then((r) => r.default));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-BmbrZjeL.mjs').then((r) => r.default));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-CDr_qslK.mjs').then((r) => r.default));
const LazyDocumentDrivenEmpty = defineAsyncComponent(() => import('./DocumentDrivenEmpty-bFMCPIdF.mjs').then((r) => r.default));
const LazyDocumentDrivenNotFound = defineAsyncComponent(() => import('./DocumentDrivenNotFound-CWCdSJNh.mjs').then((r) => r.default));
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-cNdLO6f9.mjs').then((r) => r.default));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-D5jHKwZf.mjs').then((r) => r.default));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-CTdMFk74.mjs').then((r) => r.default));
const LazyProsePre = defineAsyncComponent(() => import('./ProsePre-CKYE3ZtE.mjs').then((r) => r.default));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-pyEhfi82.mjs').then((r) => r.default));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-DZnH14o-.mjs').then((r) => r.default));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-3cGaK7nx.mjs').then((r) => r.default));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CI-PFVZZ.mjs').then((r) => r.default));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-D9OWMvnR.mjs').then((r) => r.default));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-8BHMg9UP.mjs').then((r) => r.default));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-C7FmW_k_.mjs').then((r) => r.default));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-DKTssD_N.mjs').then((r) => r.default));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BURX_mV6.mjs').then((r) => r.default));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-oYPPO8xm.mjs').then((r) => r.default));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-Bh-HCxBL.mjs').then((r) => r.default));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-1zR1g2m5.mjs').then((r) => r.default));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-DHVrqhOh.mjs').then((r) => r.default));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-BjamM63w.mjs').then((r) => r.default));
const LazyProseScript = defineAsyncComponent(() => import('./ProseScript-Bdh2N79T.mjs').then((r) => r.default));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-Dwqzr-ks.mjs').then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-C4qKOZdX.mjs').then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-DmXdl5Na.mjs').then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-BmN7e5I8.mjs').then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-Dsgz99pc.mjs').then((r) => r.default));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-BwqKE8zx.mjs').then((r) => r.default));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-9RRDbeVm.mjs').then((r) => r.default));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-DdzwFzi4.mjs').then((r) => r.default));
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CgxVub1-.mjs').then((r) => r.default));
const LazyOgImageStatic = defineAsyncComponent(() => import('./Static-BqprxtK4.mjs').then((r) => r.default));
const LazyOgImageDynamic = defineAsyncComponent(() => import('./Dynamic--LccSeAp.mjs').then((r) => r.default));
const LazyOgImage = defineAsyncComponent(() => import('./index-Z-fhCNfI.mjs').then((r) => r.default));
const LazyOgImageCached = defineAsyncComponent(() => import('./Cached-BWqJe5ir.mjs').then((r) => r.default));
const LazyOgImageWithoutCache = defineAsyncComponent(() => import('./WithoutCache-CovFemRL.mjs').then((r) => r.default));
const LazyOgImageScreenshot = defineAsyncComponent(() => import('./Screenshot-CPHNkl5d.mjs').then((r) => r.default));
...
const slideovers_gwj70lsfUC = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const modals_uyXV0m6Wnr = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _green = { "50": "#FFFBF2", "100": "#FEE9C8", "200": "#FED7A0", "300": "#FDC078", "400": "#FCA550", "500": "#F68D2E", "600": "#D4771B", "700": "#A35D15", "800": "#724B10", "900": "#47320A", "950": "#2C1E06" };
...
const colors_6YrnjMPmds = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  unhead_A0m63kUM0l,
  plugin,
  _0_siteConfig_Kam82Cto4d,
  revive_payload_server_K90jEFodTy,
  components_plugin_KR1HBZs4kY,
  slideovers_gwj70lsfUC,
  modals_uyXV0m6Wnr,
  colors_6YrnjMPmds,
...
_sfc_main$d.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/elements/Badge.vue");
  return _sfc_setup$d ? _sfc_setup$d(props, ctx) : void 0;
};
const __nuxt_component_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$7]]);
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/elements/Link.vue");
  return _sfc_setup$c ? _sfc_setup$c(props, ctx) : void 0;
};
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$6]]);
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt-icon@0.6.10_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/nuxt-icon/dist/runtime/Icon.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-985ea2a1"]]);
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/elements/Icon.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const __nuxt_component_2$2 = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$5]]);
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/elements/Button.vue");
  return _sfc_setup$9 ? _sfc_setup$9(props, ctx) : void 0;
};
const __nuxt_component_2$1 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$4]]);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_UColorModeImage = resolveComponent("UColorModeImage");
      const _component_UBadge = __nuxt_component_0$5;
      const _component_UContentSearchButton = resolveComponent("UContentSearchButton");
      const _component_UColorModeButton = resolveComponent("UColorModeButton");
...
const layouts = {
  docs: () => import('./docs-bf3jDntB.mjs').then((m) => m.default || m)
};
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UFooter = resolveComponent("UFooter");
      const _component_UColorModeButton = resolveComponent("UColorModeButton");
      const _component_UButton = __nuxt_component_2$1;
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/elements/Avatar.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/overlays/Notification.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/overlays/Notifications.vue");
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-B0lsAD4J.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-B0lsAD4J.mjs').then((m) => m.generateNavigation);
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLoadingIndicator = __nuxt_component_0$6;
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/@nuxt+ui@2.15.0_nuxt@3.11.1_vite@5.2.6_vue@3.4.21/node_modules/@nuxt/ui/dist/runtime/components/layout/Container.vue");
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./island-renderer-BJZMNBXR.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.1_@unocss+reset@0.58.7_eslint@8.57.0_floating-vue@5.2.2_typescript@5.4.3_unocss@0.5_vsbprmu4pg7oexd74mctklo3aa/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { ensureArray as A, omit as B, sortList as C, apply as D, withoutKeys as E, withKeys as F, createQuery as G, useNuxtApp as H, __nuxt_component_0 as I, __nuxt_component_0$2 as J, _export_sfc as _, appConfig as a, __nuxt_component_2$2 as b, createError as c, __nuxt_component_1 as d, entry$1 as default, useRoute as e, useAppConfig as f, useAsyncData as g, useSeoMeta as h, __nuxt_component_0$5 as i, __nuxt_component_0$4 as j, useHead as k, useRuntimeConfig as l, mergeConfig as m, useState as n, useContentDisabled as o, fetchContentNavigation as p, queryContent as q, useContentPreview as r, useRequestEvent as s, resolveSitePath as t, useUI as u, useRouter as v, useServerHead as w, resolveIconName as x, get as y, assertArray as z };
